...
public class AzureResourceManagerClient {
    ...
    private AuthenticationResult getAccessTokenFromUserCredentials() throws Exception {
        ...
        String authority = "https://login.windows.net/" + youxiaConfig.getString(ConfigTools.YOUXIA_AZURE_ACTIVE_DIRECTORY_TENANT_ID);
        ...
        try {
            ...
            Future<AuthenticationResult> future = context.acquireToken("https://management.azure.com/", clientID, username, password, null);
            result = future.get();
        } finally {
            service.shutdown();
        }
    ...
    private String getEndpoint(String endpoint) throws Exception {
        ...
        HttpGet request = new HttpGet("https://management.azure.com/subscriptions/" + youxiaConfig.getString(YOUXIA_AZURE_SUBSCRIPTION_ID)
                + "/" + endpoint + "?api-version=2015-01-01");
    ...
    private String patchEndpoint(String endpoint, String payload) throws IOException {
        ...
        HttpClient client = new DefaultHttpClient();
        HttpPatch request = new HttpPatch("https://management.azure.com/subscriptions/"
                + youxiaConfig.getString(YOUXIA_AZURE_SUBSCRIPTION_ID) + "/" + endpoint + "?api-version=2015-01-01");
    ...
    public static void main(String[] args) {
        ...
        try {
            System.out.println("List of resource groups");
        ...
        try {
            System.out.println("Specific resource groups");
            ResourceGroup fromJson = client.getResourceGroup("test-pc-launch");
        ...
        try {
            System.out.println("Update specific resource group");
            ResourceGroup initialGroup = client.getResourceGroup("test-pc-launch");
            Map<String, String> tags = initialGroup.getTags();
            tags.put(String.valueOf(System.currentTimeMillis()), "funky_new_tag");
            ResourceGroup updateResourceGroup = client.patchResourceGroup("test-pc-launch", tags);
