...
/**
 * This class is a starting point for working with the AWS SDK for Java, and shows how to make a few simple requests to Amazon EC2 and
 * Amazon S3.
 * 
 ...
 * this project.
 * 
 * If you don't have an Amazon Web Services account, you can get started for free: http://aws.amazon.com/free
 * 
 * For lots more information on using the AWS SDK for Java, including information on high-level APIs and advanced features, check out the
 * AWS SDK for Java Developer Guide: http://docs.aws.amazon.com/AWSSdkDocsJava/latest/DeveloperGuide/welcome.html
 * 
 * Stay up to date with new features in the AWS SDK for Java by following the AWS Java Developer Blog: https://java.awsblog.com
 */
